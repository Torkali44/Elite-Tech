...
<div class="max-w-3xl mx-auto px-4 py-12">
    <div class="card p-8">
        ...
        <div class="text-xs text-tertiary mb-4 space-y-1">
            ...
            <?php if($str('years_experience')): ?><div>خبرة: <?php echo e($str('years_experience')); ?></div><?php endif; ?>
            <?php if($str('availability')): ?><div>التوفر: <?php echo e($str('availability')); ?></div><?php endif; ?>
        ...
        <p class="text-sm text-tertiary leading-relaxed mb-6 whitespace-pre-line"><?php echo e($str('summary') ?: ($user->bio ?: 'عضو في مجتمع Elite Tech.')); ?></p>
        ...
        <?php if(auth()->guard()->check()): ?>
            <?php if(auth()->id() !== $user->id): ?>
                <a href="<?php echo e(route('network.index', ['with' => $user->id])); ?>" class="btn-secondary text-sm">تواصل</a>
            <?php else: ?>
                <a href="<?php echo e(route('profile.cv')); ?>" class="btn-outline text-sm">تعديل سيرتي</a>
            <?php endif; ?>
        <?php endif; ?>
    </div>
</div>
