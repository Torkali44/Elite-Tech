<?php $__env->startSection('title','أفكاري'); ?>
...
<div class="flex flex-wrap items-center justify-between gap-4 mb-6">
    ...
    <a href="<?php echo e(route('ideas.create')); ?>" class="btn-primary text-sm">+ إرسال فكرة جديدة</a>
</div>
...
<div class="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
    ...
    <div class="card p-5">
        ...
        <?php if($idea->admin_notes): ?>
            <p class="text-xs text-rose-600 mb-3">ملاحظة: <?php echo e($idea->admin_notes); ?></p>
        <?php endif; ?>

        <div class="flex flex-wrap gap-2 mb-3">
            <a href="<?php echo e(route('ideas.edit', $idea->id)); ?>" class="btn-outline text-xs !py-1.5 !px-3">تعديل</a>
            ...
            <?php if($idea->status === 'published'): ?>
                <a href="<?php echo e(route('ideas.show', $idea->id)); ?>" class="btn-ghost text-xs !py-1.5 !px-3">عرض</a>
            <?php endif; ?>
        </div>
        ...
        <div class="flex items-center justify-between text-xs text-tertiary border-t border-mist pt-3">
            ...
            <span><?php echo e($idea->likes_count); ?> إعجاب</span>
        </div>
    </div>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    <div class="card p-10 text-center col-span-full text-tertiary">لا أفكار بعد. <a href="<?php echo e(route('ideas.create')); ?>" class="text-secondary font-bold">أضف فكرتك</a></div>
    <?php endif; ?>
</div>
