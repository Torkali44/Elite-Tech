...
<?php endif; ?>
            ...
            <nav class="flex flex-wrap items-center gap-x-5 gap-y-2 text-sm text-tertiary">
                <a href="<?php echo e(route('ideas.index')); ?>" class="hover:text-primary transition">بنك الأفكار</a>
                <a href="<?php echo e(route('jobs')); ?>" class="hover:text-primary transition">التوظيف</a>
                <a href="<?php echo e(route('about')); ?>" class="hover:text-primary transition">عن المنصة</a>
                <a href="<?php echo e(route('terms')); ?>" class="hover:text-primary transition">الشروط</a>
                <a href="<?php echo e(route('privacy')); ?>" class="hover:text-primary transition">الخصوصية</a>
                <a href="<?php echo e(route('agreement')); ?>" class="hover:text-primary transition">اتفاقية الاستخدام</a>
            </nav>
        </div>

        <div class="border-t border-mist mt-8 pt-5 text-xs text-tertiary flex flex-wrap justify-between gap-2">
            <span>© <?php echo e(date('Y')); ?> Elite Tech Community. جميع الحقوق محفوظة.</span>
