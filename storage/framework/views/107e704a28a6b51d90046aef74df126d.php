<?php $__env->startSection('title', 'مجتمع إليت تك — حيث تلتقي الخبرة بالابتكار'); ?>
<?php $__env->startSection('description', 'انضم إلى المنصة التقنية الرائدة المدعومة من إليت تك حيث يجتمع نخبة المطورين والمبتكرين لبناء مستقبل التكنولوجيا.'); ?>
...
<section class="relative bg-gradient-to-b from-[#0a192f] via-[#0d2240] to-[#14325a] text-white overflow-hidden py-24 lg:py-32">
    ...
    <div class="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="flex flex-wrap items-center justify-center gap-4">
            <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center gap-2 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white font-bold px-8 py-3.5 rounded-xl shadow-lg shadow-orange-500/25 transition-all transform hover:-translate-y-0.5">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"/></svg>
                <span>انضم الآن</span>
            </a>
            <a href="<?php echo e(route('ideas.index')); ?>" class="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 backdrop-blur border border-white/20 text-white font-bold px-8 py-3.5 rounded-xl transition-all transform hover:-translate-y-0.5">
...
<section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
    <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10">
        ...
        <a href="<?php echo e(route('ideas.index')); ?>" class="btn-outline text-sm shrink-0">عرض كل الأفكار ←</a>
    </div>
...
<section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
    <div class="rounded-3xl bg-gradient-to-r from-[#0a192f] to-[#163866] text-white p-10 sm:p-14 flex flex-col lg:flex-row lg:items-center justify-between gap-8 shadow-xl">
        ...
        <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center justify-center bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white font-bold px-8 py-4 rounded-xl shadow-lg shadow-orange-500/25 transition shrink-0">
            انضم مجاناً اليوم
        </a>
    </div>
</section>
