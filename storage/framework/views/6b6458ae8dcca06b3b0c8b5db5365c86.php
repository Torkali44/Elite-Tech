<?php $__env->startSection('title', app()->getLocale()==='ar' ? 'مجتمع إليت تك — حيث تلتقي الخبرة بالابتكار' : 'Elite Tech Community — Where Expertise Meets Innovation'); ?>
<?php $__env->startSection('description', app()->getLocale()==='ar' ? 'انضم إلى المنصة التقنية الرائدة المدعومة من إليت تك حيث يجتمع نخبة المطورين والمبتكرين لبناء مستقبل التكنولوجيا.' : 'Join the leading tech platform powered by Elite Tech where elite developers and innovators meet to build the future of technology.'); ?>
...
<section class="relative bg-gradient-to-b from-[#0a192f] via-[#0d2240] to-[#14325a] text-white overflow-hidden py-14 sm:py-24 lg:py-32">
    ...
    <div class="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 class="font-black text-2xl sm:text-4xl lg:text-5xl tracking-tight leading-tight sm:leading-tight lg:leading-tight mb-4 sm:mb-6">
            <?php echo e(app()->getLocale()==='ar' ? 'مجتمع إيليت تك: حيث تلتقي الخبرة بالابتكار' : 'Elite Tech Community: Where Expertise Meets Innovation'); ?>
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-3.5 sm:gap-4 w-full max-w-md sm:max-w-none mx-auto">
            <a href="<?php echo e(route('register')); ?>" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white font-bold px-8 py-3.5 rounded-xl shadow-lg shadow-orange-500/25 transition-all transform hover:-translate-y-0.5 text-sm sm:text-base">
                ...
                <span><?php echo e(app()->getLocale()==='ar' ? 'انضم الآن' : 'Join Now'); ?></span>
            </a>
            <a href="<?php echo e(route('ideas.index')); ?>" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-white/10 hover:bg-white/20 backdrop-blur border border-white/20 text-white font-bold px-8 py-3.5 rounded-xl transition-all transform hover:-translate-y-0.5 text-sm sm:text-base">
                ...
                <span><?php echo e(app()->getLocale()==='ar' ? 'استكشف الأفكار' : 'Explore Ideas'); ?></span>
            </a>
        </div>
    </div>
</section>
    ...
    <div class="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
        <div class="order-1 lg:order-2">
            <div class="relative rounded-2xl overflow-hidden shadow-2xl border border-slate-200 group">
                ...
                <div class="absolute bottom-3 sm:bottom-4 <?php echo e(app()->getLocale()==='ar' ? 'right-3 sm:right-4' : 'left-3 sm:left-4'); ?> bg-white/90 backdrop-blur px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg text-[11px] sm:text-xs font-bold text-slate-800 shadow">
                    👥 <?php echo e(app()->getLocale()==='ar' ? 'مجتمع نخبة المطورين والخبراء' : 'Community of Elite Developers & Experts'); ?>
        ...
        <div class="order-2 lg:order-1 space-y-4 sm:space-y-6">
            <h2 class="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight">
                <?php echo e(app()->getLocale()==='ar' ? 'بيئة تعاونية محفزة' : 'Inspiring Collaborative Environment'); ?>
            ...
            <ul class="space-y-3 sm:space-y-4 pt-1 sm:pt-2">
                <?php $__currentLoopData = app()->getLocale()==='ar' ? [
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-2xl mx-auto mb-10 sm:mb-14">
            <h2 class="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight mb-2 sm:mb-3">
                <?php echo e(app()->getLocale()==='ar' ? 'كل ما تحتاجه للنجاح' : 'Everything You Need For Success'); ?>

            </h2>
            <p class="text-slate-600 text-sm sm:text-base">
                <?php echo e(app()->getLocale()==='ar' ? 'نقدم لك أدوات وميزات متكاملة لدعم مسيرتك المهنية' : 'We provide comprehensive tools & features to support your career'); ?>
        ...
        <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-6 lg:gap-8">
            <div class="bg-white rounded-2xl p-6 sm:p-8 border border-slate-200/80 shadow-sm hover:shadow-md transition text-center flex flex-col items-center">
                ...
                <h3 class="font-extrabold text-lg sm:text-xl text-slate-900 mb-2 sm:mb-3"><?php echo e(app()->getLocale()==='ar' ? 'مشاريع تعاونية' : 'Collaborative Projects'); ?></h3>
                <p class="text-slate-600 text-xs sm:text-sm leading-relaxed">
                    <?php echo e(app()->getLocale()==='ar' ? 'ساهم في مشاريع تقنية ملهمة وتبادل الأفكار مع أفضل المطورين في مجالك.' : 'Contribute to inspiring tech projects and exchange ideas with top developers.'); ?>
            ...
            <div class="bg-white rounded-2xl p-6 sm:p-8 border border-slate-200/80 shadow-sm hover:shadow-md transition text-center flex flex-col items-center">
                ...
                <h3 class="font-extrabold text-lg sm:text-xl text-slate-900 mb-2 sm:mb-3"><?php echo e(app()->getLocale()==='ar' ? 'تواصل مع الخبراء' : 'Connect with Experts'); ?></h3>
                <p class="text-slate-600 text-xs sm:text-sm leading-relaxed">
                    <?php echo e(app()->getLocale()==='ar' ? 'ابنِ شبكة علاقات مهنية مع مهندسي إليت تك وتزداد وضوح الأفكار.' : 'Build a professional network with Elite Tech engineers to turn ideas into reality.'); ?>
            ...
            <div class="bg-white rounded-2xl p-6 sm:p-8 border border-slate-200/80 shadow-sm hover:shadow-md transition text-center flex flex-col items-center sm:col-span-2 md:col-span-1">
                ...
                <h3 class="font-extrabold text-lg sm:text-xl text-slate-900 mb-2 sm:mb-3"><?php echo e(app()->getLocale()==='ar' ? 'إرشاد تقني متخصص' : 'Specialized Technical Guidance'); ?></h3>
                <p class="text-slate-600 text-xs sm:text-sm leading-relaxed">
                    <?php echo e(app()->getLocale()==='ar' ? 'احصل على توجيه مباشر من خبراء لتطوير مهاراتك البرمجية والقيادية.' : 'Get direct guidance from experts to develop your coding & leadership skills.'); ?>
...
<?php if(isset($featuredIdeas) && $featuredIdeas->isNotEmpty()): ?>
<section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
    <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8 sm:mb-10">
        <div>
            <h2 class="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight"><?php echo e(app()->getLocale()==='ar' ? 'أبرز الأفكار المنشورة' : 'Featured Ideas'); ?></h2>
            <p class="text-slate-600 mt-1 sm:mt-2 text-sm sm:text-base"><?php echo e(app()->getLocale()==='ar' ? 'استكشف الأفكار التقنية الجاهزة للتنفيذ في بنك الأفكار.' : 'Explore tech ideas ready for implementation in the Ideas Bank.'); ?></p>
        </div>
        <a href="<?php echo e(route('ideas.index')); ?>" class="btn-outline text-xs sm:text-sm shrink-0 self-start sm:self-auto"><?php echo e(app()->getLocale()==='ar' ? 'عرض كل الأفكار ←' : 'View All Ideas →'); ?></a>
    </div>
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-6">
        <?php $__currentLoopData = $featuredIdeas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idea): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 sm:pb-20">
    <div class="rounded-2xl sm:rounded-3xl bg-gradient-to-r from-[#0a192f] to-[#163866] text-white p-6 sm:p-10 lg:p-14 flex flex-col lg:flex-row lg:items-center justify-between gap-6 sm:gap-8 shadow-xl">
        <div class="max-w-xl">
            <h2 class="text-xl sm:text-2xl lg:text-3xl font-black mb-2 sm:mb-3"><?php echo e(app()->getLocale()==='ar' ? 'هل أنت جاهز لبناء مستقبلك التقني؟' : 'Ready to Build Your Tech Future?'); ?></h2>
            <p class="text-blue-100/80 text-xs sm:text-sm lg:text-base leading-relaxed">
                <?php echo e(app()->getLocale()==='ar' ? 'سجّل حسابك الآن، اختر مسارك المناسب، وابدأ بالتفاعل والتعاون مع نخبة المطورين وأصحاب الأفكار.' : 'Sign up now, choose your suitable path, and start collaborating with top developers & idea owners.'); ?>

            </p>
        </div>
        <a href="<?php echo e(route('register')); ?>" class="w-full sm:w-auto inline-flex items-center justify-center bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white font-bold px-8 py-3.5 sm:py-4 rounded-xl shadow-lg shadow-orange-500/25 transition shrink-0 text-sm sm:text-base">
            <?php echo e(app()->getLocale()==='ar' ? 'انضم مجاناً اليوم' : 'Join Free Today'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\E\iti-open-source\Freelance\elitetech-laravel\resources\views\pages\landing.blade.php ENDPATH**/ ?>