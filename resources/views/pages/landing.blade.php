...
<section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 sm:pb-20">
    <div class="rounded-2xl sm:rounded-3xl bg-gradient-to-r from-[#0a192f] to-[#163866] text-white p-6 sm:p-10 lg:p-14 flex flex-col lg:flex-row lg:items-center justify-between gap-6 sm:gap-8 shadow-xl">
        ...
        <a href="{{ route('register') }}" class="w-full sm:w-auto inline-flex items-center justify-center bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white font-bold px-8 py-3.5 sm:py-4 rounded-xl shadow-lg shadow-orange-500/25 transition shrink-0 text-sm sm:text-base">
