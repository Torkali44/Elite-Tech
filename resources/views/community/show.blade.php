...
<div class="max-w-5xl mx-auto px-4 py-10">
    <div class="card p-6 lg:p-8">
        <div class="flex flex-wrap items-start gap-6">
            <div class="w-28 h-28 rounded-2xl bg-primary text-white grid place-items-center text-4xl font-black">{{ mb_substr($member['name'],0,1) }}</div>
            <div class="flex-1 min-w-0">
                <h1 class="text-2xl font-black text-primary mb-1">{{ $member['name'] }}</h1>
                <p class="text-tertiary">{{ $member['title'] }}</p>
        ...
        <div class="mt-8">
            ...
            <p class="text-sm text-tertiary leading-relaxed">{{ $member['bio'] }}</p>
        </div>
        ...
        <div class="mt-8">
            ...
            <div class="flex flex-wrap gap-2">
                ...
                <span class="badge bg-neutral text-primary border border-slate-200">{{ $s }}</span>
                @endforeach
            </div>
        </div>
    </div>
